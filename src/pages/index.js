...
const Furniture = ({ products }) => {
  ...
  const banner2img = [
    ...
    "https://images.unsplash.com/photo-1608397717231-4a2883be7ad2?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1694&q=80",
